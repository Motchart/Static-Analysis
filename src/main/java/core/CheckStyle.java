...
public void Findbugs(String one) {
	one = new Integer(1).toString();		
		...
		private void switchCasePrimer1() {
		int caseIndex = 0;
		switch (caseIndex) {
		case 0:
			System.out.println("Zero");
		...
		public static void garbageAllocation2() {
			String SB = "";
			for (int i = 0; i < 1000000; i++){
				SB = SB + "Blue Moon";
			}
		...
		public static void garbageAllocation11() {
			String SB = "";
			for (int i = 0; i < SB.length();i++){
	            if((SB.charAt(i))==(SB.charAt(i+1))){
	    			System.out.println("False");
...
public void Findbugs41(String one) {
	one = new Integer(1).toString();		
	
			  }
		
		public static void NullReferences1() {
			String summer = "Great weather";
			String winter = "Snowing";
			try{
				summer.equals(winter);
		...
		public static void NullReferences12(Integer count) {
...
public void Findbugs2(String one) {
	one = new Integer(1).toString();		
